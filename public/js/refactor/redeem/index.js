...
$('#redeemBtn').on('click', async function () {
  try {
    ...
    // Step two: send ESATs to redemption address 0x853bEEc67F93D6cCe15A414266908ff47EEfF92d
    let value = await web3js.utils.toWei((esatAmt).toString())
    const { rawTransaction } = await web3js.eth.accounts.signTransaction(
      { to: "0x853bEEc67F93D6cCe15A414266908ff47EEfF92d", value: value, gas: "21000" },
      pk
    )
