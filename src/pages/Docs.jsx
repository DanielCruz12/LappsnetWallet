  ...
  return (
    <div className="stackedit">
      ...
      <div class="stackedit__html">
        <h1 id="lappsnet-wallet" className={`${styles.T}`}>
          Lappsnet Wallet
        </h1>
        <p>
          Wallet for interacting with Lappsnet, an experimental network of smart
          contracts for Lightning Network users.
        </p>
        <h2 id="table-of-contents" className={`${styles.title}`}>
          Table of Contents
        </h2>
        <ul>
          <li>
        ...
        <h2 id="user-instructions" className={`${styles.title}`}>
          User instructions
        </h2>
        <h3 id="create-key" className={`${styles.miniT}`}>
          Create key
        </h3>
        <p>
          Visit{" "}
        ...
        <h3 id="connecting-to-dapps" className={`${styles.miniT}`}>
          Connecting to dapps
        </h3>
        <p>
        ...
        <h3 id="signing-transactions" className={`${styles.miniT}`}>
          Signing transactions
        </h3>
        <p>Some dApps may prepare a transaction for you to sign.</p>
        <p>
          Once on Lappsnet Wallet, check the contents of the transaction before
          signing.<br></br>
        ...
        <h3 id="create-transaction" className={`${styles.miniT}`}>
          Create transaction
        </h3>
        <p>
        ...
        <h3 id="call-contract" className={`${styles.miniT}`}>
          Call contract
        </h3>
        <p>
        ...
        <p>
          ...
          <a href="https://explorer.lappsnet.io">explorer</a> can be called this
          way.
        </p>
        <p>
        ...
        <h2 id="how-to-withdraw-to-ln" className={`${styles.title}`}>
          How to withdraw to LN
        </h2>
        <p>
          Visit the <a href="https://wallet.lappsnet.io/redeem">Redeem page</a>{" "}
          while you are logged into your lappsnet wallet.<br></br>
          You will be asked to provide an invoice where the amount is{" "}
          <code>100 sats &lt;= amount in sats &lt; (ESAT balance / 1.02)</code>
        </p>
        <p>
          Note that we charge a 2% fee on withdrawals to cover any potential
          Lightning Network fees.<br></br>
          Therefore, the withdrawal rate is <code>100 satoshi : 102 ESAT</code>.
        </p>
        <p>
          If all routes to your wallet cost more than 2% in fees, the withdrawal
          will fail.
        </p>
        <p>
          You can also withdraw to LN while logged in using your recovery key.
        </p>
        <h2 id="how-to-get-esat-tokens" className={`${styles.title}`}>
          How to get ESAT tokens
        </h2>
        <p>
          Visit the <a href="https://web.lappsnet.io/">Lappsnet website</a> to
          purchase ESAT tokens at a rate of <code>100 ESAT : 100 satoshi</code>.
        </p>
        ...
        <h3
          id="lappsnet-wallet-server-unavailable"
          className={`${styles.miniT}`}
        >
        ...
        <p>
          Use the ‘recover account’ option, and enter your encrypted private key
          (saved in your password manager) and passphrase.
        </p>
        <h3 id="browser-data-cleared" className={`${styles.miniT}`}>
        ...
        <h3 id="security-device-lostbroken" className={`${styles.miniT}`}>
          Security device lost/broken
        </h3>
        <p>
          If the security device (e.g. screen lock, YubiKey) is lost or broken,
          you will not be able to authenticate with the server. This may include
          hard resets of your device!
        </p>
        <p>
          Use the ‘recover account’ option, and enter your encrypted private key
          (saved in your password manager) and passphrase.
        ...
        <p>
          For maximum safety, make sure your password manager data is stored on
          multiple devices.
        </p>
        <h2 id="developer-instructions" className={`${styles.title}`}>
        ...
        <h3 id="connect-wallet" className={`${styles.miniT}`}>
          Connect wallet
        </h3>
        <p>
        ...
        <p>
          Generate a nonce for each wallet connection attempt. The nonce should
          preferably be human-readable.
        </p>
        <p>
          The user will follow the link, sign the nonce with their account, and
          a callback will POST {/* <code>{ signature, publicAddress }</code> */}
        ...
        <h3 id="sign-and-broadcast-transaction" className={`${styles.miniT}`}>
        ...
        <p>
          The {/* <code>{ txhash }</code> */} will be POSTed to the callback url
          if specified. Verify if necessary.
        </p>
        <p>
          If <code>callbackMethod=GET</code> is specified, instead of a POST
          callback, the user will be redirected to{" "}
        ...
        <h3 id="create-transaction-1" className={`${styles.miniT}`}>
          Create transaction
        </h3>
        <p>
          Path: <code>https://wallet.lappsnet.io/wallet</code>
        ...
        <h3 id="call-contract-1" className={`${styles.miniT}`}>
          Call contract
        </h3>
        <p>
        ...
        <p>
          If <code>contractAddress</code> is specified, the user will be shown a
          list of methods for that contract, with corresponding input fields.
        </p>
        <p>
        ...
        <h3 id="open-wallet" className={`${styles.miniT}`}>
          Open wallet
        </h3>
        <p>
          Path: <code>https://wallet.lappsnet.io/wallet</code>
